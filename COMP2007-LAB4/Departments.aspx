      ...
      <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <a href="StudentDetails.aspx" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Department</a>
               <label for="PageSizeDropdownlist">Records per page:</label>
                ...
                <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Budget" HeaderText="Budget" Visible="true" SortExpression="Budget" DataFormatString="{0:C3}"/>
